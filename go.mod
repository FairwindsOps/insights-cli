...
// WARNING this is a temporary work-around for local development until insights-plugins go.mod files are fixed.
replace github.com/fairwindsops/insights-plugins/opa => ./../insights-plugins/plugins/opa
